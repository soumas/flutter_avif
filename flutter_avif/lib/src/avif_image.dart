...
class AvifImage extends StatefulWidget {
  ...
  AvifImage.file(
    ...
    this.frameBuilder,
           ...
           ? FileImage(file, scale: scale) as ImageProvider
           : FileAvifImage(
               file,
               scale: scale,
  ...
  AvifImage.asset(
    ...
    AssetBundle? bundle,
           ...
           ? AssetImage(name, bundle: bundle) as ImageProvider
           : AssetAvifImage(
               name,
               scale: scale,
               overrideDurationMs: overrideDurationMs,
  ...
  AvifImage.network(
    ...
    Map<String, String>? headers,
           ...
           ? NetworkImage(url, scale: scale, headers: headers) as ImageProvider
           : NetworkAvifImage(
               url,
               scale: scale,
               overrideDurationMs: overrideDurationMs,
  ...
  AvifImage.memory(
    ...
    this.frameBuilder,
           ...
           ? MemoryImage(bytes, scale: scale) as ImageProvider
           : MemoryAvifImage(
               bytes,
               scale: scale,
               overrideDurationMs: overrideDurationMs,
...
class SingleFrameAvifCodec implements AvifCodec {
  ...
  SingleFrameAvifCodec({required Uint8List bytes}) : _bytes = bytes;
